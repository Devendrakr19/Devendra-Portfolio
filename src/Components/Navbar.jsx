      ...
      <div className="pt-[20px] pb-[15px] flex justify-between items-center w-[100%] px-[15px] sm:px-[15px] md:px-[25px] lg:px-[30px] xl:px-[35px] 2xl:px-[40px]">
        ...
        <div
          className={`md:flex items-center ${
            sidebarOpen === true
              ? "flex items-center flex-col text-[#ffffff] bg-[#000000d7] absolute top-[0px] left-0 w-[100%] py-[40px]"
              : "hidden"
          } sm:gap-[10px] md:gap-[10px] lg:gap-[15px] xl:gap-[25px] 2xl:gap-[30px]`}
          data-aos="fade-down"
          data-aos-duration="1000"
        >
          ...
          {navContent.map((content, index) => (
            <div
              key={index}
              onClick={() => {
                HandleNav(content.id);
                handleClose(index);
              }}
              className={`${
                sidebarOpen === true ? "mb-[20px]" : ""
              } text-[16px] md:text-[14px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] font-medium relative cursor-pointer px-[10px] py-[6px]}`}
            >
        ...
        >
          <FaInstagram
            onClick={() => {
              window.open(
                "https://www.instagram.com/devendrapandit1715/",
                "_target"
              );
            }}
            className="cursor-pointer hover:text-[red] transition-all ease-in-out delay-75 hover:scale-125"
          />

          <FaGithub
            onClick={() => {
              window.open("https://github.com/Devendrakr19", "_target");
            }}
            className="cursor-pointer hover:text-[black] transition-all ease-in-out delay-75 hover:scale-125"
          />

          <FaLinkedin
            onClick={() => {
              window.open(
                "http://linkedin.com/in/devendrakumar-pandit-57429623b ",
                "_target"
              );
            }}
            className="cursor-pointer hover:text-[blue] transition-all ease-in-out delay-75 hover:scale-125"
          />
        </div>
